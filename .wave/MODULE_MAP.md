...
物料状态：READY
来源：INIT PRD v3；用户明确采用 Better-T-Stack，授权推荐组合。文档顺序：platform-bootstrap → workspace → characters → skills → photography → studio → gallery → app-shell；实际工程先 bootstrap，再 scaffold，再业务任务 DAG。
